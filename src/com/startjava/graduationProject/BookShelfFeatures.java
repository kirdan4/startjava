...
public class BookShelfFeatures {
    public static void start(BookShelf bookShelf, Scanner scan) {
        String reply;
        do {
    ...
    private static void addBook(BookShelf bookShelf, Scanner scan) {
        if (bookShelf.isFreeSpace()) {
            ...
            try {
                bookShelf.addBook(scan.nextLine(),scan.nextLine(),scan.nextLine());
    ...
    private static void findBook(BookShelf bookShelf, Scanner scan) {
        ...
        if (bookShelf.isBookFound(searchedBook)) {
